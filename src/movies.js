...
let howManyMovies = (movies) => {
    ...
    let spielbergDramaMovies = movies.filter(movie => {
        return (movie.genre.includes('Drama') || movie.genre.includes('drama'))
...
let orderByYear = (movies) => {
    ...
    // return orderedMovies does not compile teh Should "return a new array"
...
// Internally is teh same Array, for JS backlog you are referrencing the same array 
// to create an actual NEw Array on teh backlog of JS use 
// .MAP   or   [...xxx]   Spread
